...
└──────────────────────┬──────────────────────────┘
                       │ delegates to
┌──────────────────────▼──────────────────────────┐
│  AgentFrameworkConnector (core logic)                │
...
Customer code can use OmniChannelServer directly, or use AgentFrameworkConnector with their own FastAPI app for full control over routing and middleware.
