...
class TestPackageImports:
    """Public API surface of ``twilio_agent_connect_microsoft``."""

    def test_import_twilio_agent_connect_microsoft(self) -> None:
        import twilio_agent_connect_microsoft

        assert twilio_agent_connect_microsoft is not None

    def test_reexported_tac_core_symbols(self) -> None:
        """Core TAC symbols are re-exported at the package root."""
        from twilio_agent_connect_microsoft import TAC, TACConfig
    ...
    def test_conversation_session_exported(self) -> None:
        from twilio_agent_connect_microsoft import ConversationSession

        assert ConversationSession is not None

    def test_format_memory_context_exported(self) -> None:
        from twilio_agent_connect_microsoft import format_memory_context

        assert callable(format_memory_context)

    def test_agent_framework_connector_lazy_loaded(self) -> None:
        from twilio_agent_connect_microsoft import AgentFrameworkConnector
    ...
    def test_tac_fastapi_server_lazy_loaded(self) -> None:
        from twilio_agent_connect_microsoft import TACFastAPIServer
    ...
    def test_unknown_attr_raises(self) -> None:
        ...
        with pytest.raises(AttributeError):
            _ = twilio_agent_connect_microsoft.DoesNotExist
