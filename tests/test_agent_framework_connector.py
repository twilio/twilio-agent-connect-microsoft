...
from twilio_agent_connect_microsoft.agent_framework_connector import AgentFrameworkConnector
...
def _patched_connector(**kwargs):
    ...
    return patch.multiple(
        "twilio_agent_connect_microsoft.agent_framework_connector",
...
class TestOnMessageHook:
    ...
    def test_default_formats_memory_context(
        ...
        with patch(
            "twilio_agent_connect_microsoft.agent_framework_connector.format_memory_context",
